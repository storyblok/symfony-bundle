        ...
        $rootNode
            ->children()
                ...
                ->scalarNode('management_token')
                    ->defaultNull()
                    ->cannotBeEmpty()
                    ->info('Personal access token for the Storyblok Management API. Required only for the "make:storyblok:block" maker command.')
                ->end()
                ->scalarNode('space_id')
                    ->defaultNull()
                    ->cannotBeEmpty()
                    ->info('The Storyblok space id. Required only for the "make:storyblok:block" maker command.')
                ->end()
